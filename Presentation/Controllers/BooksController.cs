...
{
	//[ApiVersion("1.0")]  // service extension tarafında belirlendi.
	[ServiceFilter(typeof(LogFilterAttribute))]
	[ApiController]
	[Route("api/books")]
	[ApiExplorerSettings(GroupName = "v1")]
	//[ResponseCache(CacheProfileName = "5mins")] // program.cs controller yapısında profil oluşturduk 
	//[HttpCacheExpiration(CacheLocation = CacheLocation.Public, MaxAge =80)] // validation model
	public class BooksController : ControllerBase
	{
		...
		public async Task<IActionResult> CreateOneBookAsync([FromBody] BookDtoForInsertion bookDto)
		{
			...
			return StatusCode(201, book); // createdatroute() response header ına location koyar.
		}
